          ...
          <hr>
           <div class="field">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" name="price" placeholder="Name">
                  <span class="icon left"><i class="mdi mdi-account"></i></span>
                  @error('price')
          ...
          <hr>
           <div class="field">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="file" name="image" placeholder="Name">
                  <span class="icon left"><i class="mdi mdi-account"></i></span>
                  @error('image')
          ...
          <hr>
           <div class="field">
            ...
            <div class="field-body">
              <div class="field">
                <div class="control icons-left">
                  <input class="input" type="text" name="mota" placeholder="Name">
                  <span class="icon left"><i class="mdi mdi-account"></i></span>
                  @error('mota')
